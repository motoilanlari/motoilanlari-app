...
const ContactPage = () => {
    ...
    const sendWhatsAppMessage = () => {
        const phoneNumber = ''; // Telefon numarasını ayarla
        const message = `Merhaba, ilanınız hakkında bilgi almak istiyorum.`;
        const url = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`;
        // WhatsApp'a yönlendirme
        Linking.openURL(url).catch((err) => console.error('WhatsApp açma hatası: ', err));
    };

    // Instagram sayfasına yönlendirmek için
    const openInstagram = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.iconButton} onPress={sendWhatsAppMessage}>
                <Svg width={120} height={120} version="1.1" id="Layer_1" viewBox="0 0 512 512"
